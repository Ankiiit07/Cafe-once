...
export const metadata = {
  title: 'Contact Us - Cafe@once',
  description: 'Get in touch with Cafe@once for inquiries, feedback, or support. Fill out our contact form or find our contact details.',
};
