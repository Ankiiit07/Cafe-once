    ...
    <div className="space-y-12">
      <header className="text-center">
        ...
        <p className="text-xl text-foreground max-w-2xl mx-auto">
          Everything you need to know about how we get your Latte Bliss to you, and our returns policy.
        </p>
      </header>
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 lg:col-span-1">
          ...
          <CardContent className="space-y-3 text-foreground">
            <p>We are thrilled to offer shipping for all Latte Bliss India products across the nation!</p>
...
export const metadata = {
  title: 'Shipping & Returns - Latte Bliss India',
  description: 'Information about Latte Bliss India shipping policies, delivery timelines across India, and our return policy for coffee concentrates.',
};
