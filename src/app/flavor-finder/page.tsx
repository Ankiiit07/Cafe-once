    ...
    <div className="space-y-12">
      <header className="text-center">
        ...
        <p className="text-xl text-foreground max-w-3xl mx-auto">
          Let our smart assistant help you choose the perfect Cafe@once concentrate. Just tell us a bit about your tastes and dietary needs!
        </p>
      </header>
...
export const metadata = {
  title: 'AI Flavor Finder - Cafe@once',
  description: 'Discover your ideal Cafe@once coffee concentrate flavor with our AI-powered recommendation tool. Input your preferences and dietary restrictions for a personalized suggestion.',
};
